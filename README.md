...
- `/1/` short/common-ASCII, `/2/` general, and `/3/` long/query-heavy are headerless radix formats with different static prefix-code tables for token symbols. The UI can auto-pick the shortest; `/0/` payloads still decode for compatibility.
